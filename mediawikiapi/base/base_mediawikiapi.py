...
class BaseMediaWikiAPI(ABC, Generic[P, T]):
    ...
    def random(
        self, pages: int = 1
    ) -> Union[Union[str, List[str]], Awaitable[Union[str, List[str]]]]:
        """
    ...
    def is_feature_available(
        self, feature: str, language: Optional[Union[str, Language]] = None
    ) -> bool:
        """
    ...
    def get_api_version(
        self, language: Optional[Union[str, Language]] = None
    ...
    def _prepare_search_params(
        self, query: str, results: int, suggestion: bool
    ) -> WikiQuery:
        """
    ...
    def _handle_error_response(
        self, response: WikiResponse, query_identifier: str
    ) -> None:
        """
    ...
    def _process_random_results(
        self, response: WikiResponse, pages: int
