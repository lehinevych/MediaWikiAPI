...
MEDIAWIKI_1_19 = MediaWikiVersion(
    1, 19, 0, "MediaWiki 1.19.0"
)  # Oldest supported version
MEDIAWIKI_1_25 = MediaWikiVersion(
    1, 25, 0, "MediaWiki 1.25.0"
)  # Added some new features
MEDIAWIKI_1_32 = MediaWikiVersion(1, 32, 0, "MediaWiki 1.32.0")  # Added more features
MEDIAWIKI_1_34 = MediaWikiVersion(
    1, 34, 0, "MediaWiki 1.34.0"
)  # Enhanced content parsing
MEDIAWIKI_1_35 = MediaWikiVersion(
    1, 35, 0, "MediaWiki 1.35.0"
)  # Long-term support release
MEDIAWIKI_1_39 = MediaWikiVersion(
    1, 39, 0, "MediaWiki 1.39.0"
...
def get_available_features(version: MediaWikiVersion) -> List[str]:
    ...
    return [
        feature
        for feature, required_version in FEATURE_AVAILABILITY.items()
