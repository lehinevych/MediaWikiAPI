...
def process_random_results(response: WikiResponse, pages: int) -> Union[str, SearchResults]:
    """
...
def extract_page_properties(response: WikiResponse, property_name: str) -> Dict[str, Any]:
    """
