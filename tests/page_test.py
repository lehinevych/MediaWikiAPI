...
class TestPage(unittest.TestCase):
    ...
    def test_backlinks(self):
        ...
        self.assertCountEqual(
            self.celtuce.backlinks, mock_data["data"]["celtuce.backlinks"]
        )
        self.assertCountEqual(
            self.cyclone.backlinks, mock_data["data"]["cyclone.backlinks"]
        )

    def test_backlinks_ids(self):
        """Test the backlinks ids."""
        self.assertCountEqual(
            self.celtuce.backlinks_ids, mock_data["data"]["celtuce.backlinks_ids"]
        )
        self.assertCountEqual(
            self.cyclone.backlinks_ids, mock_data["data"]["cyclone.backlinks_ids"]
        )
    ...
    def test_hanging_page_image_query(self):
        ...
        self.assertCountEqual(
            bill_foster_page.images, mock_data["data"]["bill_foster_page.images"]
        )
    ...
    def test_coordinates(self):
        ...
        self.assertEqual(
            ...
            mock_data["data"]["great_wall_of_china.coordinates.lat"],
        )
        self.assertEqual(
            str(lon.quantize(Decimal("1.000"))),
            mock_data["data"]["great_wall_of_china.coordinates.lon"],
        )
    ...
    def test_categories(self):
        ...
        self.assertCountEqual(
            self.celtuce.categories, mock_data["data"]["celtuce.categories"]
        )
        self.assertCountEqual(
            self.cyclone.categories, mock_data["data"]["cyclone.categories"]
        )

    def test_sections(self):
        """Test the list of section titles."""
        self.assertCountEqual(
            self.cyclone.sections, mock_data["data"]["cyclone.sections"]
        )
    ...
    def test_section(self):
        ...
        self.assertEqual(
            ...
            mock_data["data"]["cyclone.section.seasonal_forecasts"],
        )
    ...
    def test_lang_title(self):
        ...
        self.assertEqual(
            self.cyclone.lang_title("ru"), mock_data["data"]["cyclone.ru_lang"]
        )
    ...
    def test_category_members(self):
        ...
        self.assertEqual(
            ...
            mock_data["data"]["category_members_physics"],
        )
        self.assertEqual(
