...
mock_references: List[str] = [
    ...
    "https://www.gardensmart.tv/?p=articles&title=Celtuce",
    "https://www.google.com/search?as_eq=wikipedia&q=%22Celtuce%22",
    "https://www.google.com/search?tbm=nws&q=%22Celtuce%22+-wikipedia&tbs=ar:1",
    "https://www.google.com/search?&q=%22Celtuce%22&tbs=bkt:s&tbm=bks",
    "https://www.google.com/search?tbs=bks:1&q=%22Celtuce%22+-wikipedia",
    "https://scholar.google.com/scholar?q=%22Celtuce%22",
]
...
mock_bill_foster_images: List[str] = [
    "https://upload.wikimedia.org/wikipedia/commons/4/4d/Edward_Teller_%281958%29-LLNL-restored.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/a/a2/Einstein_oppenheimer.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/5/57/Eisenhower_and_Strauss.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/f/f8/Groves_and_Oppenheimer.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/9/90/HD.4G.039_%2810537699636%29.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/8/82/Heinkel_He_111_during_the_Battle_of_Britain.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/6/6a/J._Robert_Oppenheimer_visit_to_Israel_%28997009326988305171%29_%28cropped%29.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/1/1a/J_Robert_Oppenheimer_signature.svg",
    "https://upload.wikimedia.org/wikipedia/commons/3/3b/Leiden_Kamerlingh-Onnes_Lab.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/f/fe/Los_Alamos_colloquium.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/a/aa/Newton%27s_reflecting_telescope.jpg",
    "https://upload.wikimedia.org/wikipedia/commons/1/1b/Nuvola_apps_kaboodle.svg",
    "https://upload.wikimedia.org/wikipedia/commons/a/ab/Oppenheimer-j_r.jpg",
    ...
    "https://upload.wikimedia.org/wikipedia/commons/a/ab/J._Robert_Oppenheimer_at_the_Guest_Lodge%2C_Oak_Ridge%2C_in_1946_4.jpg",
...
mock_data: Dict[str, str | int | Dict[str, str] | List[str]] = {
    ...
    "cyclone.revid": 1197763446,
    "cyclone.parentid": 1197585562,
    "cyclone.section.seasonal_forecasts": "Philip J. Klotzbach, William M. Gray, and their associates at Colorado State University issue forecasts of hurricane activity each year, separately from NOAA. Klotzbach's team, formerly led by Gray, determined the average number of storms per season between 1950 and 2000 to be 9.6 tropical storms, 5.9 hurricanes, and 2.3 major hurricanes (storms exceeding Category 3 on the Saffir–Simpson scale). A normal season, as defined by NOAA, has 9 to 12 named storms, of which five to seven reach hurricane strength, and one to three become major hurricanes.",
    ...
    "great_wall_of_china.geo_seach_with_non_existing_article_name": ["Test"],
    "infobox_avatar": {
